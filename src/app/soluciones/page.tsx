  ...
  return (
    <div className="relative min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <main className="pt-40 px-6 max-w-6xl mx-auto space-y-20">
        ...
        {/* Banner CTA */}
        <section className="w-full flex flex-col md:flex-row h-auto md:h-[600px] bg-[rgb(234,247,255)] dark:bg-slate-800">
          <div className="w-full md:w-1/2 flex flex-col justify-center px-8 py-12 space-y-6">
            ...
            <Link
              href="/#footer"
              className="text-lg px-6 py-3 bg-blue-600 text-white hover:bg-blue-700 w-fit rounded"
            >
              Solicita una demo
            </Link>
          </div>
      ...
      <footer id="footer" className="snap-start text-white py-10" style={{ backgroundColor: '#343432' }}>
        <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-8">
          ...
          <div>{/* espacio para formulario si lo añades más tarde */}</div>
        </div>
